                ...
                try Quest.retrieveQuestList { (quests, error) in
                    ...
                    if quests?.count == 0 || quests == nil{
                        while count <= 10 {
                            ...
                            dict["winnersAmount"] = "0"
                            dict["claimersAmount"] = "0"
                            
                            do{
                                let quest = try Quest(obj: dict, context: BaseUtil.mainContext)
                                quest.hexColor = "FFBB87"
                                quest.lat1 = 18.488476
                                quest.lon2 = -69.973723
                                quest.lat2 = 18.490114
                                quest.lon2 = -69.972489
                                quest.lat3 = 18.489901
                                quest.lon3 = -69.973873
                                quest.lat4 = 18.488201
                                quest.lon4 = -69.971803
